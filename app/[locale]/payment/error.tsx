      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            {isFrench ? 'Erreur de paiement' : 'Payment Error'}
          </h2>
          
          <p className="text-gray-600 mb-6">
            {isFrench
              ? 'Une erreur s\'est produite lors du chargement de la page de paiement. Vos données sont sécurisées.'
              : 'An error occurred while loading the payment page. Your data is safe.'}
          </p>
