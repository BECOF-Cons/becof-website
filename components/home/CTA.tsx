        ...
        >
          ...
          <div className="mt-10">
            <Link
              ...
              className="group inline-flex items-center rounded-full bg-white px-8 py-4 text-lg font-semibold text-indigo-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all"
            >
              {t('bookAppointment')}
